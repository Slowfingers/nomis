...
const translations = {
  ru: {
    ...
    'install.ios.intro': 'Установите Nomis на главный экран iPhone для быстрого доступа, как обычное приложение.',
    'install.ios.step1.title': 'Откройте меню',
    'install.ios.step1.desc': 'Нажмите кнопку «Поделиться» внизу экрана Safari.',
    'install.ios.step1.button': 'Поделиться',
    'install.ios.step2.title': 'Добавьте на экран',
    'install.ios.step2.desc': 'Прокрутите вниз и выберите «На экран «Домой»».',
    'install.ios.step2.button': 'На экран «Домой»',
    'install.ios.step3.title': 'Готово!',
    'install.ios.step3.desc': 'Нажмите «Добавить» в правом верхнем углу. Иконка Nomis появится на главном экране.',
    'install.android.intro': 'Установите Nomis на главный экран Android для быстрого доступа, как обычное приложение.',
    'install.android.step1.title': 'Откройте меню',
    'install.android.step1.desc': 'Нажмите на три точки в правом верхнем углу браузера.',
    'install.android.step1.button': 'Меню',
    'install.android.step2.title': 'Установите приложение',
    'install.android.step2.desc': 'Выберите «Установить приложение» или «Добавить на главный экран».',
    'install.android.step2.button': 'Установить',
    'install.android.step3.title': 'Готово!',
    'install.android.step3.desc': 'Подтвердите установку. Иконка Nomis появится на главном экране.',
  },
  en: {
    'app.name': 'Nomis',
    'app.slogan': 'Never miss',
    ...
    'install.ios.intro': 'Install Nomis on your iPhone home screen for quick access, just like a regular app.',
    'install.ios.step1.title': 'Open menu',
    'install.ios.step1.desc': 'Tap the "Share" button at the bottom of Safari.',
    'install.ios.step1.button': 'Share',
    'install.ios.step2.title': 'Add to screen',
    'install.ios.step2.desc': 'Scroll down and select "Add to Home Screen".',
    'install.ios.step2.button': 'Add to Home Screen',
    'install.ios.step3.title': 'Done!',
    'install.ios.step3.desc': 'Tap "Add" in the top right corner. The Nomis icon will appear on your home screen.',
    'install.android.intro': 'Install Nomis on your Android home screen for quick access, just like a regular app.',
    'install.android.step1.title': 'Open menu',
    'install.android.step1.desc': 'Tap the three dots in the top right corner of your browser.',
    'install.android.step1.button': 'Menu',
    'install.android.step2.title': 'Install app',
    'install.android.step2.desc': 'Select "Install app" or "Add to Home screen".',
    'install.android.step2.button': 'Install',
    'install.android.step3.title': 'Done!',
    'install.android.step3.desc': 'Confirm installation. The Nomis icon will appear on your home screen.',
  },
  uz: {
    'app.name': 'Nomis',
    'app.slogan': 'Never miss',
    ...
    // Install Guide
    'install.title': 'Ilovani o\'rnatish',
    'install.close': 'Tushunarli',
    'install.ios.intro': 'Tez kirish uchun Nomis-ni iPhone bosh ekraniga o\'rnating, oddiy ilova kabi.',
    'install.ios.step1.title': 'Menyuni oching',
    'install.ios.step1.desc': 'Safari pastidagi "Ulashish" tugmasini bosing.',
    'install.ios.step1.button': 'Ulashish',
    'install.ios.step2.title': 'Ekranga qo\'shing',
    'install.ios.step2.desc': 'Pastga aylantiring va "Bosh ekranga qo\'shish" tanlang.',
    'install.ios.step2.button': 'Bosh ekranga qo\'shish',
    'install.ios.step3.title': 'Tayyor!',
    'install.ios.step3.desc': 'Yuqori o\'ng burchakdagi "Qo\'shish" tugmasini bosing. Nomis belgisi bosh ekranda paydo bo\'ladi.',
    'install.android.intro': 'Tez kirish uchun Nomis-ni Android bosh ekraniga o\'rnating, oddiy ilova kabi.',
    'install.android.step1.title': 'Menyuni oching',
    'install.android.step1.desc': 'Brauzer yuqori o\'ng burchagidagi uch nuqtani bosing.',
    'install.android.step1.button': 'Menyu',
    'install.android.step2.title': 'Ilovani o\'rnating',
    'install.android.step2.desc': '"Ilovani o\'rnatish" yoki "Bosh ekranga qo\'shish" tanlang.',
    'install.android.step2.button': 'O\'rnatish',
    'install.android.step3.title': 'Tayyor!',
    'install.android.step3.desc': 'O\'rnatishni tasdiqlang. Nomis belgisi bosh ekranda paydo bo\'ladi.',
  }
};
